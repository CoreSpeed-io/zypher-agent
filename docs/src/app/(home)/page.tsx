        ...
        <div className="grid lg:grid-cols-[1fr_1.2fr] gap-12 lg:gap-12 items-center">
          ...
          <div className="flex flex-col order-2 lg:order-1">
            ...
            >
              ...
              <img
                src="https://jsr.io/badges/@zypher/agent"
                alt="JSR"
              />
            </Link>
            ...
            {/* Install Command */}
            <div className="mb-8 inline-flex items-center gap-3 px-4 py-2.5 border border-fd-border w-fit text-sm font-mono bg-fd-background">
              <svg className="w-5 h-5 text-fd-foreground" viewBox="0 0 128 128" fill="currentColor">
              ...
              <span className="text-fd-muted-foreground">deno add jsr:@zypher/agent</span>
              <CopyButton text="deno add jsr:@zypher/agent" />
            </div>
