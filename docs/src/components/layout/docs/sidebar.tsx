...
const itemVariants = cva(
  "relative flex cursor-pointer flex-row tracking-[-0.02em] text-[13px] items-center gap-2 leading-[140%] px-4 py-3 border-b border-outline-low text-start text-text-high font-mono wrap-anywhere [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
