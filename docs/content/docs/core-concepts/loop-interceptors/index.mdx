...
SecurityInterceptor: COMPLETE → ComplianceInterceptor: COMPLETE → Task finishes

// First CONTINUE wins, subsequent interceptors are skipped
SecurityInterceptor: COMPLETE → ComplianceInterceptor: CONTINUE → New LLM request (MaxTokensInterceptor skipped)
```
