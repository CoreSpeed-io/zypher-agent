...
export const EditFileTool = defineTool({
  ...
  parameters: z.object({
    ...
    instructions: z.string().describe('A single sentence instruction describing what you are going to do for the edit'),
    codeEdit: z.string().describe('The complete new content for the file. This will replace the entire existing content or create a new file.'),
  }),
